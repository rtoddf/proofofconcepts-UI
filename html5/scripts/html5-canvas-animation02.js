...
// define an objevt to hold all out images, so images
...
// creates a drawable object which will be the base class for all drawable objects. Sets up default vars that
// all child objects wil inherit, as well as the default functions
function Drawable(){
